...
export const workProjects = [
  {
    ...
    name: "品牌宣发主视觉与海报设计",
    type: "海报banner、宣传物料",
    englishType: "Posters, banners, promotional materials",
    subtitle: "海报banner、宣传物料",
    englishSubtitle: "Posters,banners,and Promotional Materials",
    category: "02.落地项目",
    year: "4周",
    tags: ["海报banner", "宣传物料"],
    time: "制作时间：4周（团队协作）",
    ...
    detailVideo: null,
    detailMeta: [
      { label: "项目类型", value: "海报banner/宣传物料" },
      { label: "制作周期", value: "4周" },
